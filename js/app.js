 ...
 */
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".main-page")) new core(".main-page__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
        ...
        window.onload = function() {
            ...
            function documentActions(e) {
                const targetElement = e.target;
                if (targetElement.classList.contains("search-header__btn")) document.querySelector(".header__content").classList.toggle("_show"); else if (!targetElement.closest(".header__content") && document.querySelector(".header__content._show")) document.querySelector(".header__content").classList.remove("_show");
                if (targetElement.classList.contains("search-header__close")) document.querySelector(".header__content").classList.remove("_show");
            }
        };
        ...
        if (document.querySelector(".catalog__mob-filter")) {
            const filterMob = document.querySelector(".catalog__mob-filter");
            filterMob.addEventListener("click", showCatalogMob);
            function showCatalogMob(e) {
                if (e.target.classList.contains("catalog__mob-filter-button")) {
                    e.target.closest(".catalog__mob-filter").classList.add("_active");
                    e.target.closest(".catalog__mob-filter").closest("body").classList.add("_filter-lock");
                }
                if (e.target.classList.contains("catalog__mob-filter-content-close")) {
                    e.target.closest(".catalog__mob-filter").classList.remove("_active");
                    e.target.closest(".catalog__mob-filter").closest("body").classList.remove("_filter-lock");
                }
            }
        }
        window["FLS"] = true;
